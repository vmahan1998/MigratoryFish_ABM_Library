...
| **Chapter 16 Tutorial — Landward Migration & STST** | [GitHub](https://github.com/vmahan1998/Sample_ABM_Tutorials) | Intermediate integration example: sawtooth tidal velocity, least-cost routing, STST gatekeeper, schooling nested inside `migrate-landward`. NetLogo, R, and Python implementations. |
