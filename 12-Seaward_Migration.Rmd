...
{V_{\max} - V_{\min}}  \hspace{2cm} \text{(12.1)} 
$$
...
$$
 D_{travel}
=
\frac{A_{\text{speed}}}{3}  \hspace{2cm} \text{(12.10)} 
$$
...
|V_{\text{patch}}|
+
0.5 \cdot \max(0, \Delta d)  \hspace{2cm} \text{(12.11)} 
$$
...
$$
 \text{cost}
=
\text{cost}_{\text{raw}} \cdot D_f  \hspace{2cm} \text{(12.12)} 
$$
...
$$
 E_{\text{swim}}
=
swim_{base} \cdot M_{swim}^{\beta}  \hspace{2cm} \text{(12.14)} 
$$
...
$$
 E_{\text{agent}}
=
\max \left(0,\, E_{\text{agent}} - E_{\text{swim}} \right)  \hspace{2cm} \text{(12.15)} 
$$
