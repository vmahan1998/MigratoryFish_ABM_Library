...
+ V_{\text{impact}}  \hspace{2cm} \text{(11.7)} 
$$
...
$$
 V_{\text{desired}} 
= \min(V_{\max}, \max(V_{\min}, V_{\text{desired}}))  \hspace{2cm} \text{(11.8)} 
$$
...
$$
 \text{cost}_{\text{raw}}
= |V_{\text{patch}}|
+ 0.5 \cdot \max(0, \Delta \text{depth})  \hspace{2cm} \text{(11.11)} 
$$
...
$$
 \text{cost}
= \text{cost}_{\text{raw}} \cdot D_f  \hspace{2cm} \text{(11.12)} 
$$
